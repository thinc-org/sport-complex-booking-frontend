                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div style={{ marginBottom: '24px' }}>
                            <ToggleButtonGroup type="radio" name="is_thai_language" defaultValue={false}>
                                <ToggleButton variant="toggle" inputRef={register} value={true}>{t('th')}</ToggleButton>
                                <ToggleButton variant="toggle" inputRef={register} value={false}>{t('en')}</ToggleButton>
                            </ToggleButtonGroup>
                        </div>
                        ...
                        <div className="button-group">
                            <Button variant="pink" type='submit'>{t('continue')}</Button>
                        </div>
                    </Form>
                </div>
            </Container>
