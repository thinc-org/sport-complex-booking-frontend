...
class AddUser extends Component {
      ...
      renderAddModal = () => {
            return (
                  <Modal show={this.state.showAdd} onHide={() => { this.setState({ showAdd: false }) }} backdrop="static" keyboard={false} >
                        <Modal.Header closeButton>
                              <Modal.Title>คำเตือน</Modal.Title>
                        </Modal.Header>
                        <Modal.Body style={{ fontWeight: "lighter" }}> ต้องการเพิ่มผู้ใช้หรือไม่ </Modal.Body>
                        <Modal.Footer>
                              <Button variant="outline-secondary" className="btn-normal btn-outline-pink" onClick={() => { this.setState({ showAdd: false }) }}>ยกเลิก</Button>
                              <Button variant="pink" className="btn-normal" onClick={this.requestAdd}>ยืนยัน</Button>
                        </Modal.Footer>
                  </Modal>
            )
      }
      ...
      renderComModal = () => {
            return (
                  <Modal show={this.state.showCom} onHide={() => { this.setState({ showCom: false }) }} backdrop="static" keyboard={false} >
                        ...
                        <Modal.Footer>
                              <Button variant="pink" className="btn-normal" onClick={() => { this.setState({ showCom: false }) }}>ตกลง</Button>
                        </Modal.Footer>
                  </Modal>
            )
      }
                              ...
                              <Row className="pt-5">
                                    <Col className="text-right">
                                          <Link to="/listOfAllUsers">
                                                <Button size="lg" variant="outline-secondary" className="mr-2 btn-normal btn-outline-pink" >ยกเลิก</Button>
                                          </Link>
                                          <Button size="lg" variant="pink" className="btn-normal" onClick={this.handleAdd}>เพิ่ม</Button>
                                    </Col>
                              </Row>
                        </Card>
                        { this.renderAddModal()}
