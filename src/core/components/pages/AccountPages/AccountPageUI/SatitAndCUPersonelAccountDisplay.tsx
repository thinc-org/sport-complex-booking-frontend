  ...
  return (
    <div className="mx-auto col-md-6">
      ...
      <div className="default-mobile-wrapper">
        ...
        <div className="row">
          <h6 className="mx-3 mt-3">{is_thai_language? "นักเรียนโรงเรียนสาธิตจุฬา และ บุคลากรจุฬา" : "Satit Chula and CU Personel"}</h6>
        </div>
        <hr className="mx-1" />
        <div className="">
      ...
      <div className="button-group col-md-12 mt-4">
        ...
        <button className="btn-normal btn-outline-black">
          {is_thai_language ? "เปลี่ยนรหัสผ่าน" : "Change Password"}
        </button>
      </Link>
      </div>
